...
//     if (nowPage > 1) {
//       pages.push(
//         <button key="prev" onClick={() => setNowPage(nowPage - 1)}>
//           &lt;
//         </button>
//       );
//     }
...
//     for (
//       let i = Math.max(1, nowPage - visibleRange);
//       i <= Math.min(maxPage, nowPage + visibleRange);
//       i++
//     ) {
//       pages.push(
//         <button
...
//     if (nowPage < maxPage) {
//       pages.push(
//         <button key="next" onClick={() => setNowPage(nowPage + 1)}>
//           &gt;
//         </button>
//       );
//     }
...
//             <tr
//               key={member.memberno}
//               className={selectedRow === member.memberno ? 'selected' : ''}
//               onClick={() => {
//                 setSelectedRow(member.memberno);
//                 alert(`회원 정보\n\n이름: ${member.mname}\nID: ${member.id}\n전화번호: ${member.tel}`);
//               }}
//             >
...
//               <td>
//                 {/* <button className="icon-btn edit" onClick={(e) => { e.stopPropagation(); alert(`회원 ${member.id} 수정`) }}>
//                   <FaEdit />
//                 </button> */}
//                 <button className="icon-btn delete" onClick={(e) => { e.stopPropagation(); handleDelete(member.memberno, member.id) }}>
//                   <FaTrash />
//                 </button>
//               </td>
//             </tr>
