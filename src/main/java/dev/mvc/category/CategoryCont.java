...
public class CategoryCont {
    ...
    public String list_all(Model model, @ModelAttribute("categoryVO") CategoryVO categoryVO) {
        ...
        List<CategoryVO> list = categoryProc.list_all();
    ...
    public String list_search_paging(Model model,
        ...
        List<CategoryVO> list = categoryProc.list_search_paging(word, now_page, record_per_page);
        model.addAttribute("list", list);
        ...
        String paging = categoryProc.pagingBox(now_page, word, list_url, search_cnt, record_per_page, page_per_block);
